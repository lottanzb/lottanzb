...
public interface Lottanzb.SetDownloadPriorityQuery : Query<Object> {

	public abstract Gee.List<string> download_ids { get; construct set; }
	public abstract DownloadPriority new_priority { get; construct set; }

}

public class Lottanzb.SetDownloadPriorityQueryImpl : SetDownloadPriorityQuery, SimpleQuery {
