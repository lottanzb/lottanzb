...
private void test_data_size_constructors () {
	DataSize data_size;
...
private void test_data_size_getters () {
	DataSize data_size;
...
private void test_data_size_string_conversion () {
	DataSize data_size;
...
private void test_data_speed_constructors () {
...
private void test_data_speed_getters () {
	DataSpeed data_speed;
...
private void test_data_size_unit () {
	assert (DataSizeUnit.BYTES.to_string () == "bytes");
}

private void test_data_speed_string_conversion () {
	DataSpeed data_speed;
